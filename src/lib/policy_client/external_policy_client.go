...
type ExternalPolicyClient interface {
	GetPolicies(token string) ([]api_0_0_0.Policy, error)
	GetPoliciesByID(token string, ids ...string) ([]api_0_0_0.Policy, error)
	DeletePolicies(token string, policies []api_0_0_0.Policy) error
	AddPolicies(token string, policies []api_0_0_0.Policy) error
}
...
func (c *ExternalClient) GetPolicies(token string) ([]api_0_0_0.Policy, error) {
	var policies struct {
		Policies []api_0_0_0.Policy `json:"policies"`
	}
...
func (c *ExternalClient) GetPoliciesByID(token string, ids ...string) ([]api_0_0_0.Policy, error) {
	var policies struct {
		Policies []api_0_0_0.Policy `json:"policies"`
	}
...
func (c *ExternalClient) AddPolicies(token string, policies []api_0_0_0.Policy) error {
	chunks := c.Chunker.Chunk(policies)
	for _, chunk := range chunks {
		reqPolicies := map[string][]api_0_0_0.Policy{
			"policies": chunk,
		}
...
func (c *ExternalClient) DeletePolicies(token string, policies []api_0_0_0.Policy) error {
	chunks := c.Chunker.Chunk(policies)
	for _, chunk := range chunks {
		reqPolicies := map[string][]api_0_0_0.Policy{
			"policies": chunk,
