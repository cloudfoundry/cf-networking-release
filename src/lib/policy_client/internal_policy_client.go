...
func (c *InternalClient) GetPolicies() ([]api_0_internal.Policy, error) {
	var policies struct {
		Policies []api_0_internal.Policy `json:"policies"`
	}
...
func (c *InternalClient) GetPoliciesByID(ids ...string) ([]api_0_internal.Policy, error) {
	var policies struct {
		Policies []api_0_internal.Policy `json:"policies"`
	}
	if len(ids) == 0 {
