...
func (fake *Rule) Flags(chain string) []string {
...
func (fake *Rule) FlagsCallCount() int {
	fake.flagsMutex.RLock()
	defer fake.flagsMutex.RUnlock()
	return len(fake.flagsArgsForCall)
}

func (fake *Rule) FlagsArgsForCall(i int) string {
	fake.flagsMutex.RLock()
	defer fake.flagsMutex.RUnlock()
	return fake.flagsArgsForCall[i].chain
}

func (fake *Rule) FlagsReturns(result1 []string) {
	fake.FlagsStub = nil
