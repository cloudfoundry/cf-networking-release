...
// @Accept json
// @Produce json
// @Param policies body api.PoliciesPayload true "Policies to delete"
...
// @Failure 403 {object} httperror.ErrorResponse "Forbidden - insufficient permissions"
// @Failure 406 {object} httperror.ErrorResponse "Unsupported API version"
