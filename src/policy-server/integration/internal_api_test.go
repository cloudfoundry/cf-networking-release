...
var _ = Describe("Internal API", func() {
	...
	v1ExpectedResponse := `{"total_policies": 3,
		...
		"egress_policies": [
			{ "source": { "id": "live-app-1-guid", "type": "app" }, "destination": { "ips": [{"start": "10.27.1.1", "end": "10.27.1.2"}], "ports": [{"start": 8080, "end": 8081}], "protocol": "tcp" } },
			{ "source": { "id": "live-space-1-guid", "type": "space" }, "destination": { "ips": [{"start": "10.27.1.3", "end": "10.27.1.3"}], "ports": [{"start": 8080, "end": 8081}], "protocol": "tcp" } }
		]
	}`
