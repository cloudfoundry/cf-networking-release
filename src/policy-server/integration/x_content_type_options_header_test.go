...
var _ = Describe("X-Content-Type-Options Header", func() {
	var (
	...
	BeforeEach(func() {
		...
		dbConf.DatabaseName = fmt.Sprintf("xcto_test_node_%d", ports.PickAPort())
	...
	It("returns X-Content-Type-Options headers when an endpoint is hit", func() {
